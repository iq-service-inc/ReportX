...
{
    public class KBStaticOds:AbsOpenOffice
    {

        private ModelKBStaticOds kbs;
        ...
        public KBStaticOds(Type model)
        {
            trs = new List<ModelTR>();
            kbs = new ModelKBStaticOds();
            kbs.style = new ViewStyleKBStaticOds();
        ...
        public override string render(int? width = null)
        {
            ...
            kbs.body = new ViewBodyKBStaticOds(trs, width);
            ViewKBStaticOds report = new ViewKBStaticOds(kbs);
