...
{
    public class ViewKBStatic
    {
        private ModelKBStatic m;

        public ViewKBStatic(ModelKBStatic model)
        {
            m = model;
        }
...
<office:body>
    <office:text text:use-soft-page-breaks='true'>
      ...
      <text:p text:style-name='TopNotice'>
        ※<text:s/>新增知識<text:s/>(共<text:s/>{6}<text:s/>筆)
      </text:p>
      ...
      <text:p text:style-name='DownNotice'>※  編號前方若有「◎ 」，則表示該知識已失效。</text:p>
      <text:p text:style-name='Data'/>
    </office:text>
  </office:body>
