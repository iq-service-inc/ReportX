...
{
    public class ViewKBStaticOds
    {
        private ModelKBStaticOds m;

        public ViewKBStaticOds(ModelKBStaticOds model)
        {
            m = model;
        }
  ...
  <office:body>
    <office:spreadsheet>
      ...
      <table:table table:name='{2}' table:style-name='ta1'>
        ...
        <table:table-column table:style-name='Column' />
        <table:table-column table:style-name='Column' />
        <table:table-row table:style-name='Column'>
          <table:table-cell office:value-type='string'  table:number-rows-spanned='1' table:number-columns-spanned='5' table:style-name='TitleWord'>
            <text:p>{2}</text:p>
          </table:table-cell>
        ...
        <table:table-row table:style-name='Column'>
          <table:table-cell office:value-type='string' table:number-rows-spanned='1' table:number-columns-spanned='5' table:style-name='DateRange'>
            <text:p>{7} </text:p>
          </table:table-cell>
          <table:covered-table-cell />
          <table:table-cell/>
        ...
        <table:table-row table:style-name='Column'>
          <table:table-cell office:value-type='string'  table:number-rows-spanned='1' table:number-columns-spanned='5' table:style-name='User'>
            <text:p>製表人：{0}</text:p>
          </table:table-cell>
          <table:covered-table-cell />
          <table:table-cell/>
        ...
        <table:table-row table:style-name='Column'>
          <table:table-cell office:value-type='string' table:style-name='CountWord'>
            <text:p>※ 新增知識 (共 {6} 筆)</text:p>
          </table:table-cell>
        </table:table-row>
         {5}
        <table:table-row table:style-name='Row'>
          <table:table-cell office:value-type='string' table:style-name='Notice'>
            <text:p>※編號前方若有「◎」，則表示該知識已失效。</text:p>
          </table:table-cell>
        </table:table-row>
      </table:table>
    </office:spreadsheet>
